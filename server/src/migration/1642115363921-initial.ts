...
export class initial1642115363921 implements MigrationInterface {
    name = 'initial1642115363921'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "note" ADD CONSTRAINT "FK_4c5649a01b718df95c7cd17f693" FOREIGN KEY ("charSpellId") REFERENCES "char_spell"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "char_spell" ADD CONSTRAINT "FK_02d86d85fd48f9901a277db40c3" FOREIGN KEY ("characterId") REFERENCES "character"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
